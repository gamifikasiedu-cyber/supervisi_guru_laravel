<div>
    <div class="bg-white rounded-xl shadow-sm border border-slate-200 no-print">
        <div class="px-5 py-3 border-b border-slate-100 flex flex-wrap items-center gap-2">
            <span class="text-sm font-semibold text-slate-700 mr-auto">Isian Pemantauan</span>
                ...
                <table class="w-full text-sm min-w-[1100px]">
                    <thead>
                        <tr class="text-left text-xs uppercase text-slate-400 border-b border-slate-100">
                            ...
                            <th class="px-4 py-2.5 w-48">Tahap</th>
                            <th class="px-4 py-2.5 w-40">Dimensi</th>
                            <th class="px-4 py-2.5">Indikator</th>
                            <th class="px-4 py-2.5 w-24">Skor (1-4)</th>
                            <th class="px-4 py-2.5 w-44">Bukti</th>
                            <th class="px-4 py-2.5 w-44">Catatan</th>
                        </tr>
                    </thead>
                    <tbody class="divide-y divide-slate-100">
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => $it): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr>
                                ...
                                <td class="px-4 py-2 font-medium text-slate-700 text-xs"><?php echo e($it['tahap']); ?></td>
                                <td class="px-4 py-2 text-slate-600 text-xs"><?php echo e($it['dimensi']); ?></td>
                                ...
                                <td class="px-4 py-2">
                                    ...
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__errorArgs = ["items.$i.skor"];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> <p class="text-xs text-rose-600">wajib</p> <?php unset($message);
if (isset($__messageOriginal)) { $message = $__messageOriginal; }
endif;
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                </td>
            ...
            <div class="px-5 py-4 flex gap-2">
                ...
                <a href="<?php echo e(route('pemantauan.index')); ?>" class="px-4 py-2 rounded-lg bg-slate-100 text-sm text-slate-600 hover:bg-slate-200">Batal</a>
            </div>
        </form>
    </div>
    ...
    <div id="print-area">
        ...
        <div style="text-align:center; margin-bottom:10px;">
            <div style="font-size:14px; font-weight:bold; text-decoration:underline;">INSTRUMEN PEMANTAUAN PEMBELAJARAN</div>
            ...
            <tbody>
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => $it): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr>
                        ...
                        <td><strong><?php echo e($it['tahap']); ?></strong></td>
                        <td><?php echo e($it['dimensi']); ?></td>
...
<?php /**PATH D:\project\supervisi_guru laravel\resources\views\livewire\instruments\form.blade.php ENDPATH**/ ?>