        ...
        <form wire:submit="save" class="space-y-4">
            ...
            <div>
                ...
                <div class="flex items-center gap-3 mt-1">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($logo_url): ?><img src="<?php echo e($logo_url); ?>" class="w-12 h-12 rounded-lg border object-contain"><?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
...
<?php /**PATH D:\project\supervisi_guru laravel\resources\views\livewire\settings\manage.blade.php ENDPATH**/ ?>