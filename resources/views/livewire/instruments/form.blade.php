    ...
    <div class="bg-white rounded-xl shadow-sm border border-slate-200 no-print">
        ...
        <form wire:submit="save">
                    ...
                    <tbody class="divide-y divide-slate-100">
                        @foreach($items as $i => $it)
                            <tr>
                                ...
                                <td class="px-4 py-2 font-medium text-slate-700 text-xs">{{ $it['tahap'] }}</td>
                                <td class="px-4 py-2 text-slate-600 text-xs">{{ $it['dimensi'] }}</td>
                                ...
                                <td class="px-4 py-2">
                                    ...
                                    @error("items.$i.skor") <p class="text-xs text-rose-600">wajib</p> @enderror
                                </td>
            ...
            <div class="px-5 py-4 flex gap-2">
                ...
                <a href="{{ route('pemantauan.index') }}" class="px-4 py-2 rounded-lg bg-slate-100 text-sm text-slate-600 hover:bg-slate-200">Batal</a>
            </div>
        </form>
    </div>
